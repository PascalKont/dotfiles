...
def get_audio_devices():
    ...
    device_alias_re = re.compile(r'device\.alias = "(.+)"')
...
def select_device(devices):
    ...
    result = subprocess.run(['wofi', '-dmenu', '-theme-str', theme(),'-i', '-p', 'Select Audio Output Device'], input=rofi_input, text=True, stdout=subprocess.PIPE)
...
if __name__ == "__main__":
    ...
    selected_device, display_name = select_device(devices)
